...
const labels = {
  ...
  const optionsPartner = [
    ...
    { key: "popular-character", label: { ua: "Популярний\n персонаж", ru: "Популярный\n персонаж", en: "Popular\n character" } },
  ];
...
export default function PartnerChoice({ lang = "ua" , onChoose, onNext, value, contentType, onSelect }) {
  const optionsPartner = [
    { key: "friend", label: { ua: "Друг", ru: "Друг", en: "Friend" } },
    { key: "popular-character", label: { ua: "Популярний\n персонаж", ru: "Популярный\n персонаж", en: "Popular\n character" } },
  ];
   ...
   const getTitle = () => {
    ...
    const contentString = contentType && contentType[lang] ? contentType[lang] : labels[lang].error
...
/*
TODO: Сделать так когда ты выбираешь опцию, то меняется цвет кнопки как в ContentType.jsx
TODO: Также сделать так чтобы когда пользователь выбирал контент для просмотра, то в тайтл показывался контент, который выбрал человек
*/